...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AB Solutions | CRM e Portal de Projetos TOTVS Fluig" },
      {
        name: "description",
        content:
          "Plataforma da AB Solutions Consultoria para prospecção, agenda, contratos e acompanhamento de projetos TOTVS Fluig.",
      },
      { name: "author", content: "AB Solutions Consultoria" },
